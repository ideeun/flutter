...
import 'currency.dart'; // Импорт нового экрана
...
class _CustomScreenState extends State<CustomScreen> {
  ...
  // Список валют
  List<String> currencies = ['USD', 'EUR', 'GBP', 'JPY', 'RUB'];
  String? selectedCurrency = 'USD';  // Начальная валюта
  ...
  void initState() {
    super.initState();
    totalController.text = '0'; // Начальное значение Total
  }
