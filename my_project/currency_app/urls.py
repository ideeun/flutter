...
from .views import UserView, CurrencyView, LoginView, EventListView,EventDetailView,PasswordResetRequest, PasswordResetConfirm, CheckSuperuserView, CheckPasswordView
